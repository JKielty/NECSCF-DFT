...
aCL, bCL, aCR, bCR, amo_energy, bmo_energy, amo_occ, bmo_occ, en_energy, nuc_wfn, NUC_GRAD = u_scfcycle_fgh.necscf_run(mol, Q, DisVector, N, NQ, step, v, multi = 25, micro=True, egy_tol=1.0e-4, rms_tol=1.0e-4, maxcycle=50, micro_tol=1.0e-8, micro_cycle=30, cptype = 'HF-Field')
